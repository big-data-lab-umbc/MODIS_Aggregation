...
def readEntry(key,ncf,spl_num) :
	...
	#print("in readEntry - key:",  key, '\n')
	#print("in readEntry - ncf.variables[key]:", ncf.variables[key], '\n')
...
def  read_MODIS(varnames,fname1,fname2, spl_num): 
	...
	for key in varnames:
		if key == 'cloud_fraction': 
			...
			#print("before readEntry - key:", key, '\n')
			#print("before readEntry - spl_num:", spl_num, '\n')
			#print("before readEntry - ncfile:", ncfile, '\n')
...
def run_modis_aggre(fname1,fname2,day_in_year,shift_hour,NTA_lats,NTA_lons,grid_lon,grid_lat,gap_x,gap_y,filenum, \
	...
	#print("varnames in run_modis_aggre:", varnames, '\n')
	#print("day_in_year:", day_in_year, '\n')
	#print("fname1:", fname1, '\n')
	#print("fname2:", fname2, '\n')
	...
	hdfs = np.array(np.arange(len(fname1)))
	for j in hdfs: #range(2): #hdfs:
		...
		#print("varnames before calling read_MODIS:", varnames, '\n')
		#print("before call read_MODIS - fname1[j]:", fname1[j], '\n')
		#print("before call read_MODIS - fname2[j]:", fname2[j], '\n')
		#print("before call read_MODIS - spl_num:", spl_num, '\n')
...
# This is the main program for using concurrent to speed up the whole process
	...
	cluster = SLURMCluster(cores=32, memory='320 GB',processes=32, project='pi_jianwu',\
	...
	subname = 'dask_output_1month_chunk_n6_chunk192.h5'
